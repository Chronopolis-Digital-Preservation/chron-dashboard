...
@Controller
public class TestBagSummaryController {

    private RemoteNodeRepository remoteNodeRepository;

    @Autowired
    public TestBagSummaryController(RemoteNodeRepository remoteNodeRepository) {

        this.remoteNodeRepository = remoteNodeRepository;
    }

    @RequestMapping(value = "/api/v1/getTestBagSummary.json")
    @ResponseBody
